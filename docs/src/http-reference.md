...
See the [HTTP SDK](https://github.com/OptimalCNC/rtt_http) and the
[external custom-type fixture](https://github.com/OptimalCNC/rock-orocos/tree/main/tests/http-custom-datatypes).
