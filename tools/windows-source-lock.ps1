...
function Get-OrocosWindowsExpectedRepositories {
    ...
    @{
        ...
        "eigen_typekit" = "https://github.com/$sourceOrganization/rtt_geometry.git"
        ...
        "cpp-httplib" = "https://github.com/$sourceOrganization/cpp-httplib.git"
        "rtt_http" = "https://github.com/$sourceOrganization/rtt_http.git"
