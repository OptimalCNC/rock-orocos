...
param(
    ...
    [string]$EigenTypekitRepository = "https://github.com/OptimalCNC/rtt_geometry.git",
    ...
    [string]$RttOpcuaRepository = "https://github.com/OptimalCNC/rtt_opcua.git",
    [string]$HttplibRepository = "https://github.com/OptimalCNC/cpp-httplib.git",
    [string]$RttHttpRepository = "https://github.com/OptimalCNC/rtt_http.git",
    [string]$OclRepository = "https://github.com/OptimalCNC/ocl.git",
    [string]$UtilmmRepository = "https://github.com/OptimalCNC/utilmm.git",
    [string]$TypelibRepository = "https://github.com/OptimalCNC/tools-typelib.git",
    [string]$RttTypelibRepository = "https://github.com/OptimalCNC/tools-rtt_typelib.git",
    ...
    [string]$OrogenRepository = "https://github.com/OptimalCNC/tools-orogen.git",
    [string]$VcpkgRepository = "https://github.com/microsoft/vcpkg.git",
    [string]$FarbotRef = "master",
    [string]$RtlogRef = "main",
    [string]$RttRef = "dev",
    [string]$EigenTypekitRef = "923714a4fd31ffa26488bf86a4bafef91be8bc01",
