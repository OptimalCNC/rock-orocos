...
if !File.file?(workflow_path)
  ...
  unless workflow.dig("env", "PREFIX_CHANNEL") == "metanc/orocos" &&
         workflow.dig("env", "PUBLIC_CHANNEL_URL") == "https://prefix.dev/metanc/orocos"
  ...
  expected_guard = "github.event.action == 'published' && " \
                   ...
                   "github.repository == 'OptimalCNC/rock-orocos'"
...
if !File.file?(recipe_path)
...

  {
    ...
    "published documentation" => "https://github.com/OptimalCNC/rock-orocos/tree/main/docs/src"
  }.each do |contract, token|
