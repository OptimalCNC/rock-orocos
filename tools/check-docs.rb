...
book_config = File.read(File.join(docs, "book.toml"))
{
  ...
  "source repository" => 'git-repository-url = "https://github.com/OptimalCNC/rock-orocos"'
...
if install_with_pixi.nil?
  ...
  example_url = "https://github.com/OptimalCNC/rock-orocos/tree/main/examples/pixi-consumer"
